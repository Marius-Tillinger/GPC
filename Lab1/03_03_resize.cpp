...
glm::mat4
	myMatrix, resizeMatrix, matrTransl, matrScale, matrTrans, matrRot;
...
void CreateVBO(void)
{
	...
	GLfloat Vertices[] = {
		...
		50.0f, 40.0f, 0.0f, 1.0f,
		50.0f, 90.0f, 0.0f, 1.0f,
		35.0f, 80.0f, 0.0f, 1.0f,
		10.0f, 90.0f, 0.0f, 1.0f,
		// Convex
		30.0f, 20.0f, 0.0f, 1.0f,
		50.0f, 10.0f, 0.0f, 1.0f,
		70.0f, 10.0f, 0.0f, 1.0f,
		70.0f, 40.0f, 0.0f, 1.0f,
	...
	GLfloat Colors[] = {
		1.0f, 0.5f, 0.0f, 1.0f,	//	0 - portocaliu
		1.0f, 0.5f, 0.0f, 1.0f,	
		0.0f, 0.0f, 1.0f, 1.0f,
		0.0f, 0.0f, 1.0f, 1.0f,
	};
...
void RenderFunction(void)
{
	...
	//  Desenarea rotita;
	//  Matricea asociata dreptunghiul - este translatat fata de axe;
	myMatrix = resizeMatrix * matrTransl * matrRot * matrTrans;
	glUniformMatrix4fv(myMatrixLocation, 1, GL_FALSE, &myMatrix[0][0]);
	// Culoarea
	codCol = 1;
	glUniform1i(codColLocation, codCol);
